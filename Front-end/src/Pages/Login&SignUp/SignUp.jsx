      ...
      <section>
        <div>
          ...
          <div className="flex justify-center gap-9 text-center items-center h-2/3 relative top-24">
            <Link to="/signup/professional" className="bg-white p-10 rounded-lg shadow-lg w-[25%] border">
            ...
            <Link to="/signup/employer" className="bg-white p-10 rounded-lg shadow-lg w-[25%] border">
