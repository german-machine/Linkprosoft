...
export const InputComponent = ({ id, label, type }) => {
    ...
    return (
        <div>
            ...
            <input type={type} id={id} onChange={handleChange} value={inputValue} className='w-full px-4 py-2 border-none rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A66C2] bg-[#f6f6f6]' />
        </div>
    )
}
// Submit button
        ...
        <>
            ...
            <div className="mt-6">
                <div className="flex space-x-2 gap-1">
                    <button
                        type="button"
                        className=" bg-[#006FA3] text-white rounded-md hover:bg-blue-800 transition py-3 px-1"
                    >
                    ...
                    <button
                        type="button"
                        className=" bg-[#f4eeee] text-black rounded-md hover:bg-[#f4eeee] transition py-3 px-1"
                    >
