                ...
                <nav className="w-[90%]  py-[15px] mx-auto flex justify-between items-center">
                   ...
                   <Link to="/contact-us">Contact Us</Link>
                    ...
                    <div className="flex gap-3 text-[15px]">
                        <a className=" bg-bluecolor text-white font-Inter py-[10px] px-[25px] rounded-tl-[40px] rounded-br-[40px]" href="/signupAs">Sign Up</a>

                        <a className="border text-bluecolor border-bluecolor bg-#006FA3  font-Inter py-[10px] px-[25px] rounded-tl-[40px] rounded-br-[40px]" href="/userLogin">Login</a>
                    </div>
                </nav>
            </header>
        </>
